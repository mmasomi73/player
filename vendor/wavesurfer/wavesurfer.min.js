                ...
                function (_Drawer) {
                    ...
                    _createClass(MultiCanvas, [{
                        ...
                        value: function drawBars(peaks, channelIndex, start, end) {
                            ...
                            return this.prepareDraw(peaks, channelIndex, start, end, function (_ref) {
                                ...
                                for (i = first; i < last; i += step) {
                                    ...
                                    _this4.fillRect(i + _this4.halfPixel, 2 * halfH - h + offsetY, bar + _this4.halfPixel, h * 2);
                        ...
                        value: function fillRectToContext(ctx, x, y, width, height) {
                            ...
                            ctx.fillRect(x +(cornerRadius/2), y + (cornerRadius/2), width - cornerRadius, height - cornerRadius);
                        ...
                        value: function setFillStyles(entry) {
                            ...
                            entry.waveCtx.strokeStyle  = this.params.waveColor;

                            if (this.hasProgressCanvas) {
                                entry.progressCtx.fillStyle = this.params.progressColor;
                                entry.progressCtx.strokeStyle = this.params.progressColor;
                            }
                        }
                        /**
